    ...
    <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            <a href="https://flowbite.com" className="flex items-center">
                <img src="https://onedrive.live.com/embed?resid=CCDB940572A31808%2145301&authkey=%21AHmNoGVVmfwfvrM&width=500&height=500g" className="mr-3 h-6 sm:h-9" alt="Flowbite Logo" />
                <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Vagante</span>
            </a>
...
<div className="flex items-center justify-around bg-[#e3dcd6] w-screen h-[25%]">
    ...
    <div className="max-[640px]:w-[35%] 2xl:w-10% md:w-[20%] sm:w-[25%]   xl:w-[10%] h-2/5 ">
